...
from .views import IndexView, BlogView, PostView, CreatePostView, \
    AboutView, EditPostView, DeletePostView, AddCategoryView
...
urlpatterns = [
    ...
    path('blog/create/category', AddCategoryView.as_view(), name='add_category_page'),
